<?php function createImage($player,$position_no,$text,$imgname){
      if($player == "FEMALE"){
       $jpg_image = imagecreatefromjpeg('sources/female.jpg');
      ...
      {
      $jpg_image = imagecreatefromjpeg('sources/male.jpg');
